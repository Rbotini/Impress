...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-align-center align-itens-center justify-content-center">
                <form   id="formulario" class="login" action="login.php" method="post">
                    <div>
                        <h2>Impre.<span>Express</span></h2>
                    </div>
                    ...
                    <div class="form-group">
                   <input type="submit" name="submit" class=" btn btn-entrar" value="Conectar">
                   </div>
                </form>
